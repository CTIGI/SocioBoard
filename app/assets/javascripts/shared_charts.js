  ...
  $.ajax({
    ...
    success: function(rt) {
      ...
      by_measures.map(function() {
        by_measures_count += parseInt(this.children[0].children[0].innerText, 10)
      });
      ...
      var by_age_count = 0
      by_age.map(function() {
        by_age_count += parseInt(this.children[0].children[0].innerText, 10)
      });
      ...
      by_age_and_measure.map(function() {
        by_age_and_measure_count += parseInt(this.children[0].children[0].innerText, 10)
      });
      ...
      by_conformities.map(function() {
        by_conformities_count += parseInt(this.children[0].children[0].innerText, 10)
      });
